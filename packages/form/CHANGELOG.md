...
- [#795] checkbox value 를 key 값으로 바라보도록 변경 ([5b6f154](https://github.com/titicacadev/triple-frontend/commit/5b6f154)), closes [#795](https://github.com/titicacadev/triple-frontend/issues/795)
- [#795] chore: 불필요한 findIndex 를 제거합니다 ([2cf5b79](https://github.com/titicacadev/triple-frontend/commit/2cf5b79)), closes [#795](https://github.com/titicacadev/triple-frontend/issues/795)
- [#795] chore: 불필요한 import 제거 ([632aaec](https://github.com/titicacadev/triple-frontend/commit/632aaec)), closes [#795](https://github.com/titicacadev/triple-frontend/issues/795)
- [#795] fix: checkbox name 을 수정합니다 ([4e70565](https://github.com/titicacadev/triple-frontend/commit/4e70565)), closes [#795](https://github.com/titicacadev/triple-frontend/issues/795)
- [#795] fix: checkbox text -> label 로 변경합니다 ([e5a0eb0](https://github.com/titicacadev/triple-frontend/commit/e5a0eb0)), closes [#795](https://github.com/titicacadev/triple-frontend/issues/795)
- [#795] fix: checkbox value type 을 수정합니다 ([7f92db1](https://github.com/titicacadev/triple-frontend/commit/7f92db1)), closes [#795](https://github.com/titicacadev/triple-frontend/issues/795)
- [#795] fix: checkbox 를 controlled 하게 변경합니다 ([d79bc42](https://github.com/titicacadev/triple-frontend/commit/d79bc42)), closes [#795](https://github.com/titicacadev/triple-frontend/issues/795)
- [#795] fix: id 를 생성할때 name 을 고려하여 생성합니다 ([eb81707](https://github.com/titicacadev/triple-frontend/commit/eb81707)), closes [#795](https://github.com/titicacadev/triple-frontend/issues/795)
- [#795] fix: radio text 를 label 로 변경합니다 ([3c37ee2](https://github.com/titicacadev/triple-frontend/commit/3c37ee2)), closes [#795](https://github.com/titicacadev/triple-frontend/issues/795)
- [#795] fix: radio value 를 key 기준으로 변경합니다 ([160a647](https://github.com/titicacadev/triple-frontend/commit/160a647)), closes [#795](https://github.com/titicacadev/triple-frontend/issues/795)
- [#795] fix: radio 를 controlled 하게 변경합니다 ([f7906cf](https://github.com/titicacadev/triple-frontend/commit/f7906cf)), closes [#795](https://github.com/titicacadev/triple-frontend/issues/795)
- [#795] fix: radio 의 option text -> label 로 변경합니다 ([13178ca](https://github.com/titicacadev/triple-frontend/commit/13178ca)), closes [#795](https://github.com/titicacadev/triple-frontend/issues/795)
- [#795] 불필요한 hook dependency 를 제거합니다 ([268368f](https://github.com/titicacadev/triple-frontend/commit/268368f)), closes [#795](https://github.com/titicacadev/triple-frontend/issues/795)
...
- [form] action sheet selector 에서 바로 value 를 반환하도록 변경 ([3344bf3](https://github.com/titicacadev/triple-frontend/commit/3344bf3))
- [form] action sheet types 를 폴더 내부로 이동합니다 ([780c52d](https://github.com/titicacadev/triple-frontend/commit/780c52d))
- [form] checkbox key 를 제거합니다 ([013360c](https://github.com/titicacadev/triple-frontend/commit/013360c))
- [form] checkbox story 추가 ([c951b35](https://github.com/titicacadev/triple-frontend/commit/c951b35))
- [form] confirm checkbox story 추가 ([5005864](https://github.com/titicacadev/triple-frontend/commit/5005864))
- [form] feature: action-sheet selector 를 추가합니다 ([75ae884](https://github.com/titicacadev/triple-frontend/commit/75ae884))
- [form] feature: core-element 의 form 요소를 가져옵니다 ([0bf1c7a](https://github.com/titicacadev/triple-frontend/commit/0bf1c7a))
- [form] feature: form 패키지를 추가합니다 ([f7014ea](https://github.com/titicacadev/triple-frontend/commit/f7014ea))
- [form] feature: input story 를 추가합니다 ([348cdb5](https://github.com/titicacadev/triple-frontend/commit/348cdb5))
- [form] feature: select story 를 추가합니다 ([8a41f80](https://github.com/titicacadev/triple-frontend/commit/8a41f80))
- [form] feature: textarea story 를 추가합니다 ([f904ca6](https://github.com/titicacadev/triple-frontend/commit/f904ca6))
- [form] form 요소의 error type 을 수정하고 select-action-sheet story 를 추가합니다 ([fe507fc](https://github.com/titicacadev/triple-frontend/commit/fe507fc))
- [form] GenderRadio story 추가 ([484e32d](https://github.com/titicacadev/triple-frontend/commit/484e32d))
- [form] radio story 추가 ([6724bae](https://github.com/titicacadev/triple-frontend/commit/6724bae))
- [form] refactor: with form 의 help 와 error 를 그리는 조건을 변경합니다 ([efc52f3](https://github.com/titicacadev/triple-frontend/commit/efc52f3))
...
- 🩹 불필요한 수정 내역 제거 ([e249c38](https://github.com/titicacadev/triple-frontend/commit/e249c38))
...
- refactor: checkbox component type ([a95028a](https://github.com/titicacadev/triple-frontend/commit/a95028a))
...
- fix: action-sheet-selector default label 수정 ([ccadecd](https://github.com/titicacadev/triple-frontend/commit/ccadecd))
- fix: adjust feedback ([058ac9b](https://github.com/titicacadev/triple-frontend/commit/058ac9b))
...
- fix: eslint error ([1145939](https://github.com/titicacadev/triple-frontend/commit/1145939))
...
- fix: StyledComponentProps ([7fc0060](https://github.com/titicacadev/triple-frontend/commit/7fc0060))
