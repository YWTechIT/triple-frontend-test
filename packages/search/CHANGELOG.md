...
- [#1031] fix: zTier를 포함시킵니다. ([3d133b8](https://github.com/titicacadev/triple-frontend/commit/3d133b8)), closes [#1031](https://github.com/titicacadev/triple-frontend/issues/1031)
- [#1031] fix: 사용하지 않는 props는 Spread Opertor처리합니다. ([cd26148](https://github.com/titicacadev/triple-frontend/commit/cd26148)), closes [#1031](https://github.com/titicacadev/triple-frontend/issues/1031)
...
- [#352] Refactor: search 패키지에 strict 옵션 추가 ([bfe58d7](https://github.com/titicacadev/triple-frontend/commit/bfe58d7)), closes [#352](https://github.com/titicacadev/triple-frontend/issues/352)
...
- [#490] 삭제 시 발생하는 커스텀이벤트의 콜백 메서드에 삭제한 키워드를 파라메터로 추가 ([0e3c74a](https://github.com/titicacadev/triple-frontend/commit/0e3c74a)), closes [#490](https://github.com/titicacadev/triple-frontend/issues/490)
...
- [#938] Chore: onEnter 설명 보강 ([68ff814](https://github.com/titicacadev/triple-frontend/commit/68ff814)), closes [#938](https://github.com/titicacadev/triple-frontend/issues/938)
- [#938] Feature: enter를 눌렀을 때 autocomplete의 debounce를 취소 ([fa1efbc](https://github.com/titicacadev/triple-frontend/commit/fa1efbc)), closes [#938](https://github.com/titicacadev/triple-frontend/issues/938)
- [#938] Fix: (maybe BREAKING) 타이머 전체 초기화 로직 제거 ([b5fed8e](https://github.com/titicacadev/triple-frontend/commit/b5fed8e)), closes [#938](https://github.com/titicacadev/triple-frontend/issues/938)
- [#938] search에서 useDebounce 사용 ([d9efd30](https://github.com/titicacadev/triple-frontend/commit/d9efd30)), closes [#938](https://github.com/titicacadev/triple-frontend/issues/938)
...
- [search-web] feature: input ref 를 내부에 추가합니다. 삭제시 focus 될 수 있도록 합니다 ([41bc548](https://github.com/titicacadev/triple-frontend/commit/41bc548))
- [search] feature: enter 시 input blur 처리하도록 액션추가 ([4b51f7b](https://github.com/titicacadev/triple-frontend/commit/4b51f7b))
...
- [TAQ-114] 🗑 remove container ([fd8dbf7](https://github.com/titicacadev/triple-frontend/commit/fd8dbf7))
...
- ✨ search 개시 ([f2ee25f](https://github.com/titicacadev/triple-frontend/commit/f2ee25f))
- 🐛 react-contexts를 사용하는 패키지 모두 peerDependency로 의존 ([c048770](https://github.com/titicacadev/triple-frontend/commit/c048770))
- 🐛 Search 컴포넌트에서 backOrClose 제거 ([4f50210](https://github.com/titicacadev/triple-frontend/commit/4f50210))
- 🐛 삭제 버튼 클릭시 키워드 삭제 ([3d2421b](https://github.com/titicacadev/triple-frontend/commit/3d2421b))
...
- 🔨 add condition for typesafe ([7eecb40](https://github.com/titicacadev/triple-frontend/commit/7eecb40))
- 🔨 tsconfig에 reference 추가하는 스크립트 작성 ([9551de8](https://github.com/titicacadev/triple-frontend/commit/9551de8))
- 🗑remove useless fragment ([96b01ab](https://github.com/titicacadev/triple-frontend/commit/96b01ab))
- 🤔not update only undefined ([907bb03](https://github.com/titicacadev/triple-frontend/commit/907bb03))
- 1.3.7 ([dbcf3e3](https://github.com/titicacadev/triple-frontend/commit/dbcf3e3))
- add deps ([d73f0ce](https://github.com/titicacadev/triple-frontend/commit/d73f0ce))
- add onBackClick props ([d74ae15](https://github.com/titicacadev/triple-frontend/commit/d74ae15))
- change function name ([ca66cae](https://github.com/titicacadev/triple-frontend/commit/ca66cae))
- deps 삭제 ([8140e2a](https://github.com/titicacadev/triple-frontend/commit/8140e2a))
- Force focus on input element on entrances ([1c45fc5](https://github.com/titicacadev/triple-frontend/commit/1c45fc5))
- Invoke openKeyboard after focusing on input ([fefab0d](https://github.com/titicacadev/triple-frontend/commit/fefab0d))
- keyword state를 하나로 관리하고 controlledKeyword 변경 시 값을 변환 ([b02f89c](https://github.com/titicacadev/triple-frontend/commit/b02f89c))
- onEmptyKeyword 삭제 ([83d0ce7](https://github.com/titicacadev/triple-frontend/commit/83d0ce7))
- package version 업데이트 ([eaefb2c](https://github.com/titicacadev/triple-frontend/commit/eaefb2c))
- Perform delayed-focusing on input element ([6b5f581](https://github.com/titicacadev/triple-frontend/commit/6b5f581))
- release v2.41.0 ([44adc09](https://github.com/titicacadev/triple-frontend/commit/44adc09))
- Remove artificial delay for focusing ([fde910d](https://github.com/titicacadev/triple-frontend/commit/fde910d))
...
- Support controlled-input-esque way to use search ([8b5d952](https://github.com/titicacadev/triple-frontend/commit/8b5d952))
...
- web-to-native-interfaces 모듈을 peerDependencies로 설정 ([e6536f8](https://github.com/titicacadev/triple-frontend/commit/e6536f8))
- 빈 값을 보낼 때에도 업데이트 할 수 있게 ([aa6f2a5](https://github.com/titicacadev/triple-frontend/commit/aa6f2a5))
...
- fix: eslint error ([2bad12a](https://github.com/titicacadev/triple-frontend/commit/2bad12a))
...
- docs(search): 스토리 종류 보완 ([163d248](https://github.com/titicacadev/triple-frontend/commit/163d248))
