...
- [#459] Feature: min, max 값 옵셔널 처리 ([fed605a](https://github.com/titicacadev/triple-frontend/commit/fed605a)), closes [#459](https://github.com/titicacadev/triple-frontend/issues/459)
- [#459] Feature: SingleSlider 구현 ([85df83c](https://github.com/titicacadev/triple-frontend/commit/85df83c)), closes [#459](https://github.com/titicacadev/triple-frontend/issues/459)
- [#459] Feature: Slider 컴포넌트 구현 ([a4faa69](https://github.com/titicacadev/triple-frontend/commit/a4faa69)), closes [#459](https://github.com/titicacadev/triple-frontend/issues/459)
- [#459] Feature: step도 스케일 함수 적용 ([fd94618](https://github.com/titicacadev/triple-frontend/commit/fd94618)), closes [#459](https://github.com/titicacadev/triple-frontend/issues/459)
- [#459] Feature: 값이 최소, 최대 값을 넘지 못하도록 limit 과정 추가 ([6950c87](https://github.com/titicacadev/triple-frontend/commit/6950c87)), closes [#459](https://github.com/titicacadev/triple-frontend/issues/459)
- [#459] Feature: 비선형 슬라이더 구현 ([d204727](https://github.com/titicacadev/triple-frontend/commit/d204727)), closes [#459](https://github.com/titicacadev/triple-frontend/issues/459)
- [#459] Feature: 외부에서 debounceTIme 조절할 수 있도록 수정 ([d1eacba](https://github.com/titicacadev/triple-frontend/commit/d1eacba)), closes [#459](https://github.com/titicacadev/triple-frontend/issues/459)
- [#459] Fix: debouncedHandler 호출이 value만 의존하도록 수정 ([78c26d1](https://github.com/titicacadev/triple-frontend/commit/78c26d1)), closes [#459](https://github.com/titicacadev/triple-frontend/issues/459)
- [#459] Fix: 너무 많은 클래스가 생기는 현상 방지 ([561156e](https://github.com/titicacadev/triple-frontend/commit/561156e)), closes [#459](https://github.com/titicacadev/triple-frontend/issues/459)
- [#459] Refactor: RangeSlider로 이름 구체화 ([a1b4793](https://github.com/titicacadev/triple-frontend/commit/a1b4793)), closes [#459](https://github.com/titicacadev/triple-frontend/issues/459)
- [#818] slider: step이 배수가 아닐 경우 가까운 숫자로 조정 ([06a39b1](https://github.com/titicacadev/triple-frontend/commit/06a39b1)), closes [#818](https://github.com/titicacadev/triple-frontend/issues/818)
- [#818] slider: 조정된 값을 LabelComponent에 넘긴다 ([de3d07c](https://github.com/titicacadev/triple-frontend/commit/de3d07c)), closes [#818](https://github.com/titicacadev/triple-frontend/issues/818)
...
- ⬆️ slider에서 react-compound-slider 최신 버전으로 업그레이드 ([551a967](https://github.com/titicacadev/triple-frontend/commit/551a967))
...
- fix: eslint error ([78f0080](https://github.com/titicacadev/triple-frontend/commit/78f0080))
- fix: storybook error ([69c2e17](https://github.com/titicacadev/triple-frontend/commit/69c2e17))
- fix: 스토리북 빌드 가능하도록 수정 ([dbed678](https://github.com/titicacadev/triple-frontend/commit/dbed678))
- fix(slider): SingleSlider의 valuemax가 NaN으로 계산되지 않도록 수정 ([6550277](https://github.com/titicacadev/triple-frontend/commit/6550277))
...
- docs(slider): initialValues 명시 ([b07128f](https://github.com/titicacadev/triple-frontend/commit/b07128f))
- feat(slider): Handle을 focusable하게 변경 ([8c484b1](https://github.com/titicacadev/triple-frontend/commit/8c484b1))
- feat(slider): Slider에 role, aria states 추가 ([d0277ee](https://github.com/titicacadev/triple-frontend/commit/d0277ee))
...
- refactor: adjustMin, adjustMax ([0ed6541](https://github.com/titicacadev/triple-frontend/commit/0ed6541))
- Fix: rail이 여백 없이 꽉 채우도록 수정 ([8a7dfdf](https://github.com/titicacadev/triple-frontend/commit/8a7dfdf))
- Fix: Slider 기본 마진 최소화 ([082b328](https://github.com/titicacadev/triple-frontend/commit/082b328))
- Docs: README 문서 작성 ([361cf01](https://github.com/titicacadev/triple-frontend/commit/361cf01))
