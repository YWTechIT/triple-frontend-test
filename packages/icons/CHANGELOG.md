...
- [#955] ArrowIcon onClick 제거 ([3a27789](https://github.com/titicacadev/triple-frontend/commit/3a27789)), closes [#955](https://github.com/titicacadev/triple-frontend/issues/955)
...
- chore: 불필요한 assets 제거 ([785733d](https://github.com/titicacadev/triple-frontend/commit/785733d))
...
- docs(icons): fallback 처리 비활성화 ([204b5fc](https://github.com/titicacadev/triple-frontend/commit/204b5fc))
- docs(icons): Todos 추가 ([5152747](https://github.com/titicacadev/triple-frontend/commit/5152747))
- docs(icons): 아이콘 컴포넌트 사용 가이드 개선 ([c52eefb](https://github.com/titicacadev/triple-frontend/commit/c52eefb))
...
- feat(icons): close icon 추가 ([08b6654](https://github.com/titicacadev/triple-frontend/commit/08b6654))
- feat(icons): fallback 코드 ([bf174db](https://github.com/titicacadev/triple-frontend/commit/bf174db))
- feat(icons): search icon 추가 ([f6c4a11](https://github.com/titicacadev/triple-frontend/commit/f6c4a11))
- feat(icons): search-place icon 추가 ([b976ca1](https://github.com/titicacadev/triple-frontend/commit/b976ca1))
- feat(icons): 기본 구현 ([3ebefe2](https://github.com/titicacadev/triple-frontend/commit/3ebefe2))
- refactor(icons): type 및 base 컴포넌트 분리 ([0be9068](https://github.com/titicacadev/triple-frontend/commit/0be9068))
