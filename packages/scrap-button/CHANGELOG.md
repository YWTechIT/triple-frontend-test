...
- [#1027] Feature: 사용하지 않는 컴포넌트 제거 ([1c3ae9b](https://github.com/titicacadev/triple-frontend/commit/1c3ae9b)), closes [#1027](https://github.com/titicacadev/triple-frontend/issues/1027)
- [#1027] Refactor: 불필요한 role 제거 ([47e2498](https://github.com/titicacadev/triple-frontend/commit/47e2498)), closes [#1027](https://github.com/titicacadev/triple-frontend/issues/1027) [/www.w3.org/TR/html-aria/#example-2](https://github.com//www.w3.org/TR/html-aria//issues/example-2)
- [#1027] Refactor: 스크랩 여부와 스크랩 변경 함수를 반환하는 훅 이름 변경 ([50e4467](https://github.com/titicacadev/triple-frontend/commit/50e4467)), closes [#1027](https://github.com/titicacadev/triple-frontend/issues/1027)
...
- [#352] Refactor: scrap-button ts strict 옵션 설정 ([97aa84d](https://github.com/titicacadev/triple-frontend/commit/97aa84d)), closes [#352](https://github.com/titicacadev/triple-frontend/issues/352)
...
- [#493] Refactor: ScrapButton prop타입 정리 ([c00f16a](https://github.com/titicacadev/triple-frontend/commit/c00f16a)), closes [#493](https://github.com/titicacadev/triple-frontend/issues/493)
...
- [#991] Feature: ScrapButtonMask 컴포넌트 구현 ([d31457f](https://github.com/titicacadev/triple-frontend/commit/d31457f)), closes [#991](https://github.com/titicacadev/triple-frontend/issues/991)
- [#991] Feature: ScrapButtonMask에 masked prop 추가 ([978fe5c](https://github.com/titicacadev/triple-frontend/commit/978fe5c)), closes [#991](https://github.com/titicacadev/triple-frontend/issues/991)
...
- [#991] Refactor: 스크랩 버튼 파일과 index 파일 분리 ([ba93e3e](https://github.com/titicacadev/triple-frontend/commit/ba93e3e)), closes [#991](https://github.com/titicacadev/triple-frontend/issues/991)
- [#991] Refactor: 스크랩 버튼에 공통으로 들어가는 HOC 통합 ([c3a36a1](https://github.com/titicacadev/triple-frontend/commit/c3a36a1)), closes [#991](https://github.com/titicacadev/triple-frontend/issues/991)
- [scrap-button] fix: 2배 아이콘을 3 배 아이콘으로 변경합니다 ([9748f1f](https://github.com/titicacadev/triple-frontend/commit/9748f1f))
...
- Expose regular/compact scrap button separately ([cb98f29](https://github.com/titicacadev/triple-frontend/commit/cb98f29))
- Extract @titicaca/scrap-button package ([266df2b](https://github.com/titicacadev/triple-frontend/commit/266df2b))
...
- Prevent event bubbling after scrap button clicks ([a441501](https://github.com/titicacadev/triple-frontend/commit/a441501))
...
- fix: scrap-button eslint error ([8c79008](https://github.com/titicacadev/triple-frontend/commit/8c79008))
- fix: scrap-button-mask eslint error ([5e493b5](https://github.com/titicacadev/triple-frontend/commit/5e493b5))
...
- refactor(scrap-button): 코드 추상화 ([f7f7a48](https://github.com/titicacadev/triple-frontend/commit/f7f7a48))
- feat(scrap-button): 스크랩 버튼에 이벤트 추가 ([7daf040](https://github.com/titicacadev/triple-frontend/commit/7daf040))
...
- Revert: ScrapsContext없이 버튼 표시하지 않는 테스트 제거 ([c64d3e1](https://github.com/titicacadev/triple-frontend/commit/c64d3e1))
