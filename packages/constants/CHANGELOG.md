...
- feat: constant 값 추가 ([84f5506](https://github.com/titicacadev/triple-frontend/commit/84f5506))
- feat: constant 추가 ([ac10665](https://github.com/titicacadev/triple-frontend/commit/ac10665))
- feat: PASSPORT_NUMBER_REGEX를 15개로 고정 ([82b5e1a](https://github.com/titicacadev/triple-frontend/commit/82b5e1a))
- feat(constants): 공통 상수 및 정규 표현식을 담는 모듈 추가 ([043895a](https://github.com/titicacadev/triple-frontend/commit/043895a))
- feat(regex): PASSPORT_NAME_REGEX 천지인 문자 허용 regexp 추가 ([fcb82e9](https://github.com/titicacadev/triple-frontend/commit/fcb82e9))
...
- 🐛 KOREAN_REGEX에서 "|"를 제거 ([5c24db9](https://github.com/titicacadev/triple-frontend/commit/5c24db9))
...
- fix: NAME/FULL_NAME 정규 표현식 구분 ([11c05ba](https://github.com/titicacadev/triple-frontend/commit/11c05ba))
- fix: 폰 번호 정규 표현식 개선 ([c854e2a](https://github.com/titicacadev/triple-frontend/commit/c854e2a))
- fix(constant): regex 는 별도 파일로 분리 및 사용 가이드 추가 ([79c9e59](https://github.com/titicacadev/triple-frontend/commit/79c9e59))
